defmodule BottichWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="border-2 border-zinc-900 ring-zinc-700/10 relative hidden bg-gray-50 p-14 [box-shadow:6px_6px_black] ring-1 transition"
            >
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 left-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 ring-1",
        @kind == :info && "bg-gray-50 text-black ring-gray-500 fill-gray-900",
        @kind == :error && "bg-gray-50 text-black shadow-md ring-gray-500 fill-gray-900"
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BottichWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BottichWeb.Gettext, "errors", msg, opts)
    end
  end
